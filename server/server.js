...
const getVacancyApplications = require('./helpers/GET_Routes/getVacancyApplications.js');
...
app.get('/api/employer/vacancies/:vacancy_id/applications', (req, res) => {
  getVacancyApplications(req, res, knex, 'aWg8Sya0i3V');
});
